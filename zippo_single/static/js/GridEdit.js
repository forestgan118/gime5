...
function GetTableData(table) {
    ...
    console.log(tableData);
     json_str = JSON.stringify(tableData);
    //$.post("{% url 'org:org_list' %}",
    //          {
	...
	var province_select=document.getElementById("province").value
    var store_select=document.getElementById("store").value
    var date_select=document.getElementById("datetimepicker").value
