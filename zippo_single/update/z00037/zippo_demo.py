...
#print sftp_timeout
program_remote_path=str.lower(lines[4].strip())
#print program_remote_path
config_load_path=str.lower(lines[5].strip())
#print config_load_path
config_led_path=str.lower(lines[6].strip())
#print config_led_path
mov1_remote_path=str.lower(lines[7].strip())
#print mov1_remote_path
mov2_remote_path=str.lower(lines[8].strip())
#print mov2_remote_path
mov3_remote_path=str.lower(lines[9].strip())
#print mov3_remote_path
mov4_remote_path=str.lower(lines[10].strip())
#print mov4_remote_path
mov5_remote_path=str.lower(lines[11].strip())
#print mov5_remote_path
config_init_path=str.lower(lines[12].strip())
#print config_init_path
config_upgrade_path=str.lower(lines[13].strip())
