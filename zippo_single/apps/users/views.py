...
class IndexAuthView(View):
    ...
    def get(self, request,param1,param2,param3,param4):
        ...
        if province_id!=0 and city_id!=0 and store_id!=0:
            ...
            print("totalsalepro=",totalsalepro)
            print("len(totalsalepro)=",len(totalsalepro))
            if len(totalsalepro)==0:
                ...
                for data in totalsalepro:
                    totalsale.append(round(float(data['sum_pro']),2))
            ...
            if len(totalquantitypro)==0:
                ...
                for data1 in totalquantitypro:
                    totalquantity.append(float(data1['quantity_pro']))
            ...
            print ("excellent_num=",excellent_num)
            print("people_3m=",people_3m) 
            print("people_1m=",people_1m) 
            print("good_num=",good_num) 
            print("unsatisfy_num=",unsatisfy_num) 
            for pdata in people_3m:
                people3.append(float(pdata['wifi_3m_num']))
            #print ("people3=",people3)
            if len(people_3m)==0:
                people_3m1=0
            elif people_3m!=None:
                print("people3=",people3)
            ...
            print("excellent_num1=",excellent_num1)
            for go_data in good_num:
                go.append(float(go_data['good_num']))
            if len(good_num)==0:
                good_num1=0
            elif good_num!=None:
                for x in range(len(go)):
                    good_num1=good_num1+go[x]
            print("good_num1=",good_num1)
            for un_data in unsatisfy_num:
                un.append(float(un_data['unsatisfy_num']))
            ...
            print("totalsalepro=",totalsalepro)
            print("totalquantitypro=",totalquantitypro)
            print("people_3m1=",people_3m1)
            print("people_1m1=",people_1m1)
            print("excellent_num1=",excellent_num1)
            print("good_num1=",good_num1)
            print("unsatisfy_num1=",unsatisfy_num1)
        ...
        if province_id==0 and city_id==0 and store_id==0:
            ...
            if len(totalsalepro)==0:
                ...
                for data in totalsalepro:
                    totalsale.append(round(float(data['sum_pro']),2))
                for x in range(len(totalsale)):
                    totalsalepro1=totalsalepro1+float(totalsale[x])
                #print (max(sale,values=sale.get))
