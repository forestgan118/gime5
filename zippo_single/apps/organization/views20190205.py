    ...
    def get(self, request,param1,param2,param3,param4):
        ...
        if num5=='1':
            if province_id!=0 and city_id!=0 and store_id!=0:
                data_list=SaleProduct_day.objects.filter(store=store_id.values('name'),time__range=(date_from, date_to)).values('sum_pro','price_pro','sum_total_pro','quantity_total_pro','quantity_pro','time','store','city','region','province','item','classification','device_id').order_by('time')
                ...
                data_list=SaleProduct_day_city.objects.filter(city=city_id.values('name'),time__range=(date_from, date_to)).values('sum_pro','price_pro','sum_total_pro','quantity_total_pro','quantity_pro','time','store','city','region','province','item','classification','device_id').order_by('time')
                ...
                data_list=SaleProduct_day_province.objects.filter(province=province_id.values('name'),time__range=(date_from, date_to)).values('sum_pro','price_pro','sum_total_pro','quantity_total_pro','quantity_pro','time','store','city','region','province','item','classification','device_id').order_by('time')
                ...
                data_list=SaleProduct_day_region.objects.filter(region=region_id.values('name'),time__range=(date_from, date_to)).values('sum_pro','price_pro','sum_total_pro','quantity_total_pro','quantity_pro','time','store','city','region','province','item','classification','device_id').order_by('time')
                ...
                for x in range(0,len(quantity)):
                    quantity1=quantity1+quantity[x]
            data_list.update(quantity_total_pro=quantity1)
            data_list.update(sum_total_pro=sum1)
            ...
            for asset in pageinator.page(page):    
                ...
                response_data['rows'].append({
                    ...
                    "sum_total_pro1": asset['sum_total_pro'] if asset['sum_total_pro'] else "",
                    "quantity_total_pro1": asset['quantity_total_pro'] if asset['quantity_total_pro'] else "",
                })
        ...
        if num5=='2':
            if province_id!=0 and city_id!=0 and store_id!=0:
                ...
                for data in people_1:
                    pd1.append(data['wifi_1m_num'])
                #print (pd1)
                for data1 in people_3:
                    pd3.append(data1['wifi_3m_num'])
                #print (pd3)
                ...
                data_list=wifiprobeData_day_city.objects.filter(city=city_id.values('name'),time__range=(date_from, date_to)).values('wifi_1m_num','wifi_3m_num','wifi_1m_num_total','wifi_3m_num_total','time','store','city','region','province','device_id','time').order_by('time')
                ...
                data_list=wifiprobeData_day_province.objects.filter(province=province_id.values('name'),time__range=(date_from, date_to)).values('wifi_1m_num','wifi_3m_num','wifi_1m_num_total','wifi_3m_num_total','time','store','city','region','province','device_id','time').order_by('time')
                ...
                data_list=wifiprobeData_day_region.objects.filter(region=region_id.values('name'),time__range=(date_from, date_to)).values('wifi_1m_num','wifi_3m_num','wifi_1m_num_total','wifi_3m_num_total','time','store','city','province','region','device_id','time').order_by('time')
        ...
        if num5=='3':
            if province_id!=0 and city_id!=0 and store_id!=0:
                ...
                data_list=SatisfactionData_day_city.objects.filter(city=city_id.values('name'),time__range=(date_from, date_to)).values('excellent_num','good_num','unsatisfy_num','excellent_num_total','good_num_total','unsatisfy_num_total','time','store','city','region','province','device_id').order_by('time')
                ex=SatisfactionData_day_city.objects.filter(city=city_id.values('name'),time__range=(date_from, date_to)).values('excellent_num').order_by('time')
                go=SatisfactionData_day_city.objects.filter(city=city_id.values('name'),time__range=(date_from, date_to)).values('good_num').order_by('time')
                un=SatisfactionData_day_city.objects.filter(city=city_id.values('name'),time__range=(date_from, date_to)).values('unsatisfy_num').order_by('time')
                for data in ex:
                    ex1.append(data['excellent_num'])
                for data1 in go:
                    go1.append(data1['good_num'])
                ...
                data_list=SatisfactionData_day_province.objects.filter(province=province_id.values('name'),time__range=(date_from, date_to)).values('excellent_num','good_num','unsatisfy_num','excellent_num_total','good_num_total','unsatisfy_num_total','time','store','city','region','province','device_id').order_by('time')
                ex=SatisfactionData_day_province.objects.filter(province=province_id.values('name'),time__range=(date_from, date_to)).values('excellent_num').order_by('time')
                go=SatisfactionData_day_province.objects.filter(province=province_id.values('name'),time__range=(date_from, date_to)).values('good_num').order_by('time')
                un=SatisfactionData_day_province.objects.filter(province=province_id.values('name'),time__range=(date_from, date_to)).values('unsatisfy_num').order_by('time')
                for data in ex:
                    ex1.append(data['excellent_num'])
                for data1 in go:
                    go1.append(data1['good_num'])
                ...
                data_list=SatisfactionData_day_region.objects.filter(region=region_id.values('name'),time__range=(date_from, date_to)).values('excellent_num','good_num','unsatisfy_num','excellent_num_total','good_num_total','unsatisfy_num_total','time','store','city','region','province','device_id').order_by('time')
                ex=SatisfactionData_day_region.objects.filter(region=region_id.values('name'),time__range=(date_from, date_to)).values('excellent_num').order_by('time')
                go=SatisfactionData_day_region.objects.filter(region=region_id.values('name'),time__range=(date_from, date_to)).values('good_num').order_by('time')
                un=SatisfactionData_day_region.objects.filter(region=region_id.values('name'),time__range=(date_from, date_to)).values('unsatisfy_num').order_by('time')
                for data in ex:
                    ex1.append(data['excellent_num'])
                for data1 in go:
                    go1.append(data1['good_num'])
    ...
    def post(self, request,param1,param2,param3,param4):
        ...
        if num5=='1':
            if province_id!=0 and city_id!=0 and store_id!=0:
                ...
                data_list=SaleProduct_day_city.objects.filter(city=city_id.values('name'),time__range=(date_from, date_to)).values('sum_pro','price_pro','sum_total_pro','quantity_total_pro','quantity_pro','time','city','region','province','item','classification','device_id','store').order_by('time')
                sum_total_pro=SaleProduct_day_city.objects.filter(city=city_id.values('name'),time__range=(date_from, date_to)).values('sum_pro').order_by('time')
                quantity_total_pro=SaleProduct_day_city.objects.filter(city=city_id.values('name'),time__range=(date_from, date_to)).values('quantity_pro').order_by('time')
                for data in sum_total_pro:
                    sum.append(data['sum_pro'])
                ...
                data_list=SaleProduct_day_province.objects.filter(province=province_id.values('name'),time__range=(date_from, date_to)).values('sum_pro','price_pro','sum_total_pro','quantity_total_pro','quantity_pro','time','store','city','region','province','item','device_id','classification').order_by('time')
                sum_total_pro=SaleProduct_day_province.objects.filter(province=province_id.values('name'),time__range=(date_from, date_to)).values('sum_pro').order_by('time')
                quantity_total_pro=SaleProduct_day_province.objects.filter(province=province_id.values('name'),time__range=(date_from, date_to)).values('quantity_pro').order_by('time')
                for data in sum_total_pro:
                    sum.append(data['sum_pro'])
            ...
            w.write(0, 8, u"销售量")
            w.write(0, 9, u"销售额")
            w.write(0, 10, u"累计销售量")
            w.write(0, 11, u"累计销售额")
            excel_row = 1
            ...
            for data in data_list:
                ...
                quantity_pro=data['quantity_pro']
                sum_pro=data['sum_pro']
                sum_total_pro1=sum1
                quantity_total_pro1=quantity1
                ...
                w.write(excel_row, 8, quantity_pro)
                w.write(excel_row, 9, sum_pro)
                w.write(excel_row, 10, quantity_total_pro1)
                w.write(excel_row, 11, sum_total_pro1)
                excel_row += 1
            '''
        ...
        if num5=='2':
            ...
            for data in data_list:
                ...
                wifi1_total=duration_1
                wifi3_total=duration_3
                w.write(excel_row, 0, data_time)
                w.write(excel_row, 1, region)
                w.write(excel_row, 2, province)
                w.write(excel_row, 3, city)
        ...
        if num5=='3':
            ...
            for data in data_list:
                ...
                w.write(excel_row, 10, ex2)
                w.write(excel_row, 11, go2)
                w.write(excel_row, 12, un2)
